            ...
            <div class="btn-group" style="margin-bottom:10px;">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        {
                            echo '<li>';
                            echo '<a href="'.site_url('ppdb/siswa/index/'.$tahun->tahun).'">Tahun ';
                            echo $tahun->tahun;
                            echo '</a>';
                            echo '</li>';
                        }
                ...
                <?php if ($query->num_rows() > 0 ) { ?>
                    <a href="<?=site_url('ppdb/siswa/export_excel/'.$this->uri->segment(4));?>" class="btn btn-sm bg-green btn-flat"><i class="fa fa-save"></i>&nbsp;&nbsp;SAVE AS EXCEL</a>
                <?php } ?>
            </div>
            <div class="box-body">
                <?php if ($query->num_rows() > 0 ) { ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <a href="<?=site_url('ppdb/siswa/update/'.$row->id);?>" class="btn btn-sm bg-teal btn-flat" data-toggle="tooltip" data-original-title="Edit"><i class="glyphicon glyphicon-edit"></i></a>
                                <a onClick="return confirm('Apakah anda yakin data akan dihapus ?')" href="<?=site_url('ppdb/siswa/delete/'.$row->id);?>" class="btn btn-sm bg-red btn-flat" data-toggle="tooltip" data-original-title="Hapus"><i class="glyphicon glyphicon-trash"></i></a>
                            </div>
                        </td>
                    </tr>
