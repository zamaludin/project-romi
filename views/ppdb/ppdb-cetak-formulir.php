...
if ($query['photo'] != '' && file_exists('./assets/siswa/'.$query['photo'])) {
...
<table align="left" width="100%" border="0" cellpadding="3">
  ...
  <tr>
    ...
    <td width="3%">:</td>
    <td width="67%" align="left">'.$query['no_daftar'].'</td>
  </tr>
  <tr>
...
$pdf->write1DBarcode($query['no_daftar'], 'C39', 7.75, 26, 6, 2, 0.4, $style, 'M');
$pdf->Output($query['no_daftar'].'.pdf', 'I');?>