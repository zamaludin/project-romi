...
<section class="content">
    <div class="row">
        <?=form_open('ppdb-smk/hasil_seleksi/clear');?>
            ...
            <div class="btn-group" style="margin-bottom:10px;">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        {
                            echo '<li>';
                            echo '<a href="'.site_url('ppdb-smk/hasil_seleksi/'.$this->uri->segment(3).'/'.$tahun->tahun).'">Tahun ';
                            echo $tahun->tahun;
                            echo '</a>';
                            echo '</li>';
                        }
                ...
                <?php if ($query->num_rows() > 0 ) { ?>
                <a href="<?=site_url('ppdb-smk/hasil_seleksi/export_excel/'.$this->uri->segment(3).'/'.$this->uri->segment(4));?>" class="btn btn-sm bg-green btn-flat"><i class="fa fa-save"></i>&nbsp;&nbsp;SAVE AS EXCEL</a>
                <?php } ?>
            ...
            <div class="box-body">
                ...
                <table class="table table-bordered table-condensed table-striped">
                    <tr>
                        ...
                        <?php if ($this->uri->segment(3) == 'tidak_diterima') { ?>
                        <th>PILIHAN I</th>
                        <th>PILIHAN II</th>
                        <?php } ?>

                        <?php if ($this->uri->segment(3) == 'diterima') { ?>
                    ...
                    <tr>
                        ...
                        <?php if ($this->uri->segment(3) == 'diterima') { ?>
                        <td><?=$this->m_global->get_jurusan($row->hasil_seleksi);?></td>
                        <?php } ?>
                        <td>
                            <div class="btn-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <dl class="dl-horizontal">
                                                ...
                                                <?php if ($this->setting['jenjang'] == 'SMK') { ?>
                                                <dt>Pilihan I</dt>
