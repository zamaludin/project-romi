...
<script type="text/javascript">
    $(function() {
        ...
        $("#tanggal_daftar").inputmask("yyyy-mm-dd", {"placeholder": "yyyy-mm-dd"});
    });
</script>
    ...
    <?=form_open_multipart($action, array('role' => 'form', 'class'=>'form-horizontal form-bordered'));?>
        <div class="form-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input id="tanggal_daftar" readonly type="text" class="form-control" name="tanggal_daftar" value="<?=$query['tanggal_daftar']=='0000-00-00' ? '' : indo_date($query['tanggal_daftar']);?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-3 control-label">Jalur Pendaftaran</label>
                <div class="col-md-9">
                    <?=form_dropdown('jalur_pendaftaran_id', $jalur, $query['jalur_pendaftaran_id'], "class='form-control'");?>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-3 control-label">Pilihan I</label>
                <div class="col-md-9">
                    <?=form_dropdown('pilihan_1', $jurusan, $query['pilihan_1'], "class='form-control' id='pilihan_1'");?>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-3 control-label">Pilihan II</label>
                <div class="col-md-9">
                    <?=form_dropdown('pilihan_2', $jurusan, $query['pilihan_2'], "class='form-control' id='pilihan_2'");?>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control" name="nisn" value="<?=(set_value('nisn')) ? set_value('nisn') : $query['nisn']?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a href="<?=site_url('ppdb-smk/siswa');?>" class="btn btn-default btn-sm btn-flat"><i class="fa fa-angle-double-left"></i> KEMBALI</a>
                </div>
            </div>
        </div>
    </form>
