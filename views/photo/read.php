        ...
        <div class="col-md-12">
            ...
            <div class="box-body">
                ...
                <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tr>
                        <td><input type="checkbox" class="checkbox" name="photo_id[]" value="<?=$row->photo_id;?>" /></td>
                        <td><?=$no;?></td>
                        <td><img width="250" src="<?=base_url('assets/gallery/thumb/'.$row->photo_thumb);?>"></td>
                        <td><?=$row->album;?></td>
                    </tr>
                    <?php $no++; } ?>
                </table>
