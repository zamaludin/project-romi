	...
	<div class="widget">
		...
		<?php if ($this->setting['ppdb_status'] == 'open') { ?>
	        <?=form_open_multipart($action, array('role' => 'form', 'class' => 'my-style'));?>
			    ...
			    <label>
			        <span>Pilihan I :</span>
			        <?=form_dropdown('pilihan_1', $jurusan, $this->uri->segment(3) == 'update' ? $query['pilihan_1'] : $this->input->post('pilihan_1'), 'id="pilihan_1"');?>
			    </label>
			    <label>
			        <span>Pilihan II :</span>
			        <?=form_dropdown('pilihan_2', $jurusan, $this->uri->segment(3) == 'update' ? $query['pilihan_2'] : $this->input->post('pilihan_2'), 'id="pilihan_2"');?>
			    </label>
			    <br>
			    <h1>
			    ...
			    <label>
			        ...
			        <input required placeholder="Tanggal lahir diisi dengan format : YYYY-MM-DD" value="<?=isset($query['tanggal_lahir']) ? $query['tanggal_lahir'] : set_value('tanggal_lahir');?>" type="text" name="tanggal_lahir"/>
			    ...
			    <label>
	   				...
	   				echo form_dropdown('status_anak', $status_anak, isset($query['status_anak']) ? $query['status_anak'] : $this->input->post('status_anak'));?>
			    </label>
			    <label>
			        <span>Anak Ke :</span>
