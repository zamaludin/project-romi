...
<script type="text/javascript">
    $(function() {
        ...
        $("#captcha").inputmask("99999", {"placeholder": "*****"});
    });
</script>
	...
	<div class="widget">
		...
		<?php if ($this->setting['ppdb_status'] == 'open') { ?>
	        <?=form_open_multipart($action, array('role' => 'form', 'class' => 'my-style'));?>
			    ...
			    <label>
			        <span>NISN :</span>
			        <input placeholder="Nomor Induk Siswa Nasional" value="<?=isset($query['nisn']) ? $query['nisn'] : set_value('nisn');?>" type="text" name="nisn"/>
			        <?=form_error('nisn');?>
			    </label>
			    <br>
			    <h1>
			    ...
			    <label>
			        ...
			        <?=form_dropdown('status_anak', ['Anak Kandung' => 'Anak Kandung','Anak Angkat' => 'Anak Angkat'], isset($query['status_anak']) ? $query['status_anak'] : $this->input->post('status_anak'));?>
			    </label>
			    <label>
			        <span>Anak Ke :</span>
			    ...
			    <label>
			        ...
			        <input value="<?=isset($query['telp_ortu']) ? $query['telp_ortu'] : set_value('telp_ortu');?>" type="text" name="telp_ortu"/>
			    ...
			    <label>
			        <span>&nbsp;</span>
			        <input id="captcha" required type="text" name="captcha" placeholder="Untuk keamanan, silahkan masukan 5 angka diatas" />
			        <?=form_error('captcha');?>
			    </label>
