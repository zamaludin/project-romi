	...
	<div class="widget">
        ...
        <?=form_open_multipart('#', array('role' => 'form', 'class' => 'my-style'));?>
		    ...
		    <label class="submit">
		    	<br><br>
		        <span>&nbsp;</span>
		        <a href="<?=site_url('ppdb-sd/cetak/index/' . $this->uri->segment(4));?>" target="_blank" class="button">CETAK</a>
		        <a href="<?=site_url('ppdb-sd/registration/update/' . $this->uri->segment(4));?>" class="warning">PERBAIKI DATA</a>
		        <br><br>
		    </label>
		</form>
