...
<section id="main-content" class="home">
	<div class="widget-title">
		<h4><i class="icon-flag"></i> <?=$title;?></h4>
	</div>
	<div class="widget">
			      			...
			      			<ul class="post-list">
					        	<li class="clearfix">
					        		<div class="left-columns" style="min-height:150px;width: 35%;">
				                        ...
				                        <img width="200px" height="200px" style="margin-top:3px;" src="<?=base_url('assets/post/thumb/' . $row->post_image);?>">
				                        <?php } else {?>
				                        <img width="200px" height="200px" style="margin-top:3px;" src="<?=base_url('assets/190x190.gif');?>">
				                        <?php } ?>
						      		</div>
