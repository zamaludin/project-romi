...
class Motivasi extends MY_Controller {

   private $pk = 'id';
   private $table = 'kata_motivasi';
   ...
   public function index() {
      ...
      $config['base_url'] = site_url('motivasi/index');
      ...
      $this->data['title'] = 'Kata Motivasi';
      $this->data['module'] = $this->data['motivasi'] = TRUE;
      $this->data['alert'] = $this->session->flashdata('alert');
      $this->data['query'] = $this->db->get($this->table, $config['per_page'], $this->uri->segment(3));
      $this->data['content'] = 'motivasi/read';
   ...
   public function create() {
      if ($_POST) {
         ...
         $this->data['content'] = 'motivasi/create';
         $this->load->view('backend/index', $this->data);
      }
   }
   ...
   private function validation() {
      ...
      $this->form_validation->set_rules('content', 'Kata Motivasi', 'trim|required');
      $this->form_validation->set_rules('author', 'Kutipan Dari', 'trim|required');
      $this->form_validation->set_error_delimiters('', '<br>');
      return $this->form_validation->run();
   }
}

/* End of file motivasi.php */
/* Location: ./application/controllers/motivasi.php */