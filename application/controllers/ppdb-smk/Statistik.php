...
class Statistik extends MY_Controller {
   ...
   public function index() {
      redirect('ppdb-smk/statistik/frontend');
   }
   ...
   public function frontend() {
      ...
      $this->data['per_jalur'] = $this->m_global->per_jalur($tahun);
      $this->data['per_pilihan_1'] = $this->m_global->per_jurusan($tahun, 'pilihan_satu');
      $this->data['per_pilihan_2'] = $this->m_global->per_jurusan($tahun, 'pilihan_dua');
      $this->data['per_kelamin'] = $this->m_global->per_kelamin($tahun);
      $this->data['per_sekolah'] = $this->m_global->per_sekolah($tahun);
      $this->data['content'] = 'themes/' . $this->setting['themes'] . '/ppdb-smk/ppdb-statistik';
      $this->load->view('themes/' . $this->setting['themes'] . '/index', $this->data);
   }

   public function redirect_tahun() {
      redirect('ppdb-smk/statistik/tahun/' . $this->input->post('tahun'));
   }
