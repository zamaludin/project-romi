...
class Hasil_seleksi extends MY_Controller {
   ...
   public function index() {
      redirect('ppdb/hasil_seleksi/diterima');
   }

   public function diterima() {
      $tahun = $this->uri->segment(4) == FALSE ? $this->setting['ppdb_tahun'] : $this->uri->segment(4);
      $this->load->library('pagination');
      $config['base_url'] = site_url('ppdb/hasil_seleksi/diterima/' . $tahun);
      ...
      $this->data['content'] = 'ppdb/hasil_seleksi';
