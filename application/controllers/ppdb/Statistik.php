...
class Statistik extends MY_Controller {
   ...
   public function index() {
      redirect('ppdb/statistik/frontend');
   }
   ...
   public function frontend() {
      ...
      $this->data['content'] = 'themes/' . $this->setting['themes'] . '/ppdb/ppdb-statistik';
      $this->load->view('themes/' . $this->setting['themes'] . '/index', $this->data);
   }

   public function redirect_tahun() {
      redirect('ppdb/statistik/tahun/' . $this->input->post('tahun'));
   }
